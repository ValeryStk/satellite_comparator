...
{
    uts::showErrorMessage("Ошибка разбора XML", "Заголовочный файл XML повреждён");
    uts::showErrorMessage("Ошибка разбора TXT", "Заголовочный файл TXT повреждён");
    uts::showErrorMessage("Ошибка разбора JSON","Заголовочный файл JSON повреждён");
}
