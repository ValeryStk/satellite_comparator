...
bool saveJsonObjectToFile(
    const QString& path, const QJsonObject& json_object,
    QJsonDocument::JsonFormat format = QJsonDocument::Indented);

bool saveJsonArrayToFile(
    const QString& path, const QJsonArray& json_object,
    QJsonDocument::JsonFormat format = QJsonDocument::Indented);

QPair<bool, QJsonObject> isJsonObjectContainsUserKeys(
    const QJsonObject& path, const QJsonArray& service_keys,
