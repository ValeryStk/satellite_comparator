...
qreal SatelliteGraphicsView::getMaxZValue(QGraphicsScene *scene) {
    const QList<QGraphicsItem *> items =
        scene->items();  // предотвращает detach
...
QVector<QPoint> SatelliteGraphicsView::getPointsInsidePolygon(
    QGraphicsPolygonItem *polygonItem, QGraphicsPixmapItem *imageItem) {
...
void SatelliteGraphicsView::zoomOut() { scale(0.8, 0.8); }
