...
class calculation_solver: public QObject {
 ...
 public:
  ...
  static double calculateAlbedo(double tau, double beta, double g, int band_number, double band_value);
...
double calculateAlbedo(double tau, double beta, double g, int band_number, double band_value);
